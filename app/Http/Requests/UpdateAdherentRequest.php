...
class UpdateAdherentRequest extends FormRequest
{
    ...
    {
        return auth()->check() && auth()->user()->estAdministrateur();
    }

    /**
     * Calcule le statut mineur à partir de la date de naissance pour piloter
     * les règles conditionnelles (représentant légal).
     */
    ...
    public function rules(): array
    {
        return [
            ...
            // Nouveau certificat médical (facultatif ; date requise si fichier fourni)
